...
public class c2_TransformingSequence extends TransformingSequenceBase {
    ...
    public void transforming_sequence() {
        Flux<Integer> numbersFlux = numerical_service().map(i -> i + 1);
...
//    void transform(Integer a, String b ){
//        if (a == 0){
//            b = ""
//        }
//    }
...
//        Flux<String> resultSequence = null;
    ...
    @Test
    public void cast() {
        Flux<String> numbersFlux = object_service().cast(String.class);
//                .map(i -> (String) i); //todo: change this line only
    ...
    public void sequence_sum() {
        ...
        Mono<Integer> sum;
        Mono<Integer> integerMono = numerical_service().reduce(0, (a, b) -> a + b);
        Integer res = integerMono.block();
        sum = Mono.just(res);
        //don't change code below
